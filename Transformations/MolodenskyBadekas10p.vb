...
Public Class MolodenskyBadekas10p
    ...
    Public Overrides Function GetParams() As List(Of ParamNameValue)
        Dim tmpList As New List(Of ParamNameValue) From {
            ...
            New ParamNameValue("Pivot Point X", ipx, ParamType.Angle, True),
            New ParamNameValue("Pivot Point Y", ipy, ParamType.Angle, True),
            New ParamNameValue("Pivot Point Z", ipz, ParamType.Angle, True)
        }
